...
const BooleanFilter: FC<BooleanFilterProps> = memo(
    ...
    return (
      <div className="flex flex-col">
        ...
        <Root value={currentValue} onValueChange={handleValueChange}>
          <Trigger className="p-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white hover:bg-gray-50 data-[placeholder]:text-gray-500 hover:cursor-pointer inline-flex items-center justify-between h-9.5 dark:bg-slate-900 dark:border-slate-600">
          ...
          <Portal>
            <Content className="overflow-hidden bg-white dark:bg-slate-900 rounded-md shadow-lg border border-gray-200 dark:border-slate-800 z-50">
